...
function DashboardApp({ user, onLogout }: { user: AuthUser; onLogout: () => Promise<void> }) {
  ...
  const [hasPendingTransactionPreview, setHasPendingTransactionPreview] = useState(false);
